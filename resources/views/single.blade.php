                ...
                <main class="main">
                    <div class="col-lg-10 col-lg-offset-1">
                        ...
                        <div class="blog-details-author">
                            ...
                            <div class="blog-details-author-content">
                                <div class="author-info">
                                    <h5 class="author-name">{{$user->post->name}}</h5>
                                </div>
                                <p class="text">
                                ...
                                <div class="socials">
                                    ...
                                    <a href="{{$post->user->profile->facebook}}" class="social__item">
                                        <img src="{{asset('app/svg/circle-facebook.svg')}}" target="_blank" alt="facebook">
                                    </a>
        
                                    <a href="{{$post->user->profile->youtube}}" class="social__item">
                                        <img src="{{asset('app/svg/youtube.svg')}}" target="_blank" alt="youtube">
                                    </a>
                        ...
                        <div class="pagination-arrow">
                            ...
                            @if($prev)
                            <a href="{{route('post.single'['slug'=>$post->slug])}}" class="btn-next-wrap">
